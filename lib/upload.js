...
function CompositeValidator() {
    ...
    function addListeners(validator) {
        ...
        validator.on('complete', validationCompleted);
    }
...
function Upload(aUploadSessionId, aForm) {
    if (!(this instanceof Upload)) return new Upload;
    ...
    var mimetypeValidator = new MimetypeValidator(form);
    mimetypeValidator.on('error', validationError);
    mimetypeValidator.on('complete', validationComplete);
    validators.push(mimetypeValidator);

    var rollingFileSizeValidator = new RollingFileSizeValidator(form);
    rollingFileSizeValidator.on('error', validationError);
    rollingFileSizeValidator.on('complete', validationComplete);
    validators.push(rollingFileSizeValidator);
    */
